...
// GetSupportedLanguage returns the closest supported language to the user's locale list
func GetSupportedLanguage() string {
	...
	return closestSupportedLocale(all).LanguageString()
}
...
func updateLocalizer() {
	...
	setupLang(GetSupportedLanguage())
}
